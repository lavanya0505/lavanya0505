...
[![Interactive Portfolio](https://img.shields.io/badge/Interactive_Portfolio-Visit-22D3EE?style=for-the-badge&logo=googlechrome&logoColor=071018)](https://lavanya0505.github.io)
...
![Profile Views](https://komarev.com/ghpvc/?username=lavanya0505&color=A855F7&style=for-the-badge&label=PROFILE+VIEWS)
</div>

<img src="./assets/rule-dark.svg#gh-dark-mode-only" width="100%" alt="" />
<img src="./assets/rule-light.svg#gh-light-mode-only" width="100%" alt="" />
...
```text
[01] Agent Memory       → persistent context across workflows
[02] Graph RAG          → relationships over documents
[03] LLM Judge          → models evaluating models
[04] Multimodal Agents  → text + vision + documents
[05] MCP Tooling        → agents connected to external tools
[06] AI Observability   → traces, failures, latency and quality
```

<img src="./assets/memory-dark.svg#gh-dark-mode-only" width="100%"/><img src="./assets/memory-light.svg#gh-light-mode-only" width="100%"/>
...
- ✍️ Co-author on AI-powered gesture-recognition research manuscript
